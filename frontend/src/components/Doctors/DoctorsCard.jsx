  ...
  return (
    <div className='p-3 lg:p-5 '>
        ...
        <div className='mt-2 lg:mt-4 flex items-center justify-between '>
            <span className='bg-[#CCF0F3] text-irisBlueColor py-1 px-2 lg:py-2 lg:px-6 rounded-[50px] text-[12px] lg:text-[16px] font-semibold  gap-1 leading-4 lg:leading-7 '>
                {specialization}
            </span>
        ...
        <div className='mt-[18px] lg:mt-5 flex itms-center justify-between'>
            <div>
                <h3 className='text-[16px] leading-7  lg:text-[18px] lg:leading-[30px] font-semibold text-headingColor'>+{totalPatients} Patients</h3>
                <p className='text__para'>At {hospital}</p>
            </div>
            <Link to='/doctors/1' className="w-[44px] h-[44px] rounded-full border border-solid border-[#181A1E] 
